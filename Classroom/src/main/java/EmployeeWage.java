...
class EmployeeWage implements InEmployeeWage{
 // constant
...
numberOfWorkingDays, int maxHrPerMonth) {
 CompanyEmpWage companyEmpWage = new CompanyEmpWage(company,
empRatePerHr, numberOfWorkingDays, maxHrPerMonth);
...
companyEmpWage.setTotalEmpWage(this.computeEmpWage(companyEmpWage));
 ...
 // computation
 while (totalEmpHrs <= companyEmpWage.maxHrPerMonth &&
totalWorkingDays < companyEmpWage.numberOfWorkingDays) {
 ...
 totalEmpHrs += empHrs;
 System.out.println(
 "totalWorkingDays: " + totalWorkingDays + "/ daily empHrs: "
+ empHrs + "/ totalEmpHrs: " + totalEmpHrs);
 } // while
 ...
 System.out.println("Total wage of queried company: " +
empWageBuilder.getTotalEmpWage("accenture"));
 }// main()
}// class
